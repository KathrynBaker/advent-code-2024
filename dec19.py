...
available_chars_count = Counter(available_string)
del available_chars_count[","]
del available_chars_count[" "]
chars_available = available_chars_count.keys()

print(available_chars_count)
print(chars_available)

for thing in reversed(available_chars_count.most_common()):
    print(thing)
